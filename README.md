...
The Streamlit UI and chat management.

utils.py

Core RAG logic: data loading, TF-IDF retrieval, and Groq API calls.

config.py

Stores the API key, LLM name, and the grounding prompt.
